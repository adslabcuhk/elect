 ...
 * <p>
 * The constructor parameter {@code intervals} determines how many values will
 * be
...
public class RandomDiscreteTimestampGenerator extends UnixEpochTimestampGenerator {
   ...
   * @throws IllegalArgumentException if the intervals is larger than
   *                                  {@link #MAX_INTERVALS}
   */
   ...
   * 
   * @param timeUnits      The time units of the returned Unix Epoch timestamp (as
   *                       well
   *                       as the units for the interval).
