 ...
 * derived from system properties. For version 1, this is simply the cluster
 * name.
 *
 ...
 * {@link #constructTokenFromProperties(Map)}
...
public class FileSystemOwnershipCheck implements StartupCheck {
    ...
    public void execute(StartupChecksOptions options) throws StartupException {
        ...
        // Step 1: Traverse the filesystem from each target dir upward, looking for
        // marker files
        ...
        // If more than one marker file was found in the tree for any target directory,
        // error
        ...
        if (byHash.keySet().size() > 1) {
            ...
            // they're all unique, but even then the number of individual files should be
            // low
    ...
    /**
     * In version 1, we check and return the ownership token. Extend this for custom
